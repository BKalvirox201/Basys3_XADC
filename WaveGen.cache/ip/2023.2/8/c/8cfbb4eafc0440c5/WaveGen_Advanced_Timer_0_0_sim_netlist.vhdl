...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Advanced_Timer is
  ...
  signal prescaler_reg : STD_LOGIC_VECTOR ( 15 downto 3 );
  ...
  attribute SOFT_HLUTNM of \capture_compare_value_buff[0]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \capture_compare_value_buff[10]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \capture_compare_value_buff[11]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \capture_compare_value_buff[12]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \capture_compare_value_buff[13]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \capture_compare_value_buff[14]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \capture_compare_value_buff[15]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \capture_compare_value_buff[1]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \capture_compare_value_buff[2]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \capture_compare_value_buff[3]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \capture_compare_value_buff[4]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \capture_compare_value_buff[5]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \capture_compare_value_buff[6]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \capture_compare_value_buff[7]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \capture_compare_value_buff[8]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \capture_compare_value_buff[9]_i_1\ : label is "soft_lutpair4";
  attribute ADDER_THRESHOLD : integer;
  attribute ADDER_THRESHOLD of \prescaler_reg[0]_i_1\ : label is 11;
  attribute ADDER_THRESHOLD of \prescaler_reg[12]_i_1\ : label is 11;
  attribute ADDER_THRESHOLD of \prescaler_reg[4]_i_1\ : label is 11;
  attribute ADDER_THRESHOLD of \prescaler_reg[8]_i_1\ : label is 11;
...
\auto_reload_register_value_buff[13]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"008A"
    )
        port map (
...
\prescaler_reg[12]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => prescaler_reg(15 downto 12)
    );
...
\prescaler_reg[4]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => prescaler_reg(7 downto 4)
    );
...
\prescaler_reg[8]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => prescaler_reg(11 downto 8)
    );
