...
/* 0-1V */
(* CORE_GENERATION_INFO = "WaveGen,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=WaveGen,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=10,numReposBlks=10,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=8,numPkgbdBlks=0,bdsource=USER,\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"da_clkrst_cnt\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "WaveGen.hwdef" *) 
module WaveGen
   (JA4,
    XA1_N,
    XA1_P,
  ...
  wire Net;
  wire [11:0]Net1;
  wire [11:0]Recursive_Filter_0_data_out;
  wire [11:0]Recursive_Filter_1_data_out;
  ...
  assign JA4 = Advanced_Timer_0_PWM_OUT;
  ...
  WaveGen_Advanced_Timer_0_0 Advanced_Timer_0
       (.PWM_OUT(Advanced_Timer_0_PWM_OUT),
        .auto_reload_register_value(Recursive_Filter_1_data_out),
        .capture_compare_value(Recursive_Filter_0_data_out),
        .clk(clk_1));
