...
--               c:/Xilinx/Projects/WaveGen/WaveGen.gen/sources_1/bd/WaveGen/ip/WaveGen_xadc_wiz_0_0/WaveGen_xadc_wiz_0_0_sim_netlist.vhdl
...
entity WaveGen_xadc_wiz_0_0 is
  port (
  ...
  attribute NotValidForBitStream of WaveGen_xadc_wiz_0_0 : entity is true;
end WaveGen_xadc_wiz_0_0;

architecture STRUCTURE of WaveGen_xadc_wiz_0_0 is
...
inst: unisim.vcomponents.XADC
    generic map(
      ...
      IS_DCLK_INVERTED => '0',
      SIM_DEVICE => "7SERIES",
      SIM_MONITOR_FILE => "C:/Xilinx/Projects/WaveGen/ADC_Sim_Data.txt"
    )
        port map (
      ALM(7) => alarm_out,
