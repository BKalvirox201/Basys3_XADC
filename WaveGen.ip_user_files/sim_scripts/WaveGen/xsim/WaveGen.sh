...
#
# Script generated by Vivado on Thu Jun 20 10:40:19 +0100 2024
...
#
# Usage        : WaveGen.sh
#                WaveGen.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                WaveGen.sh [-reset_run]
#                WaveGen.sh [-reset_log]
#                WaveGen.sh [-help]
#
...
# script info
echo -e "WaveGen.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./WaveGen.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xlconstant_v1_1_8 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot WaveGen xil_defaultlib.WaveGen xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim WaveGen -key {Behavioral:sim_1:Functional:WaveGen} -tclbatch cmd.tcl -protoinst "protoinst_files/WaveGen.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb WaveGen.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./WaveGen.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: WaveGen.sh [-help]\n\
Usage: WaveGen.sh [-step]\n\
Usage: WaveGen.sh [-lib_map_path]\n\
Usage: WaveGen.sh [-reset_run]\n\
Usage: WaveGen.sh [-reset_log]\n\
Usage: WaveGen.sh [-keep_index]\n\
Usage: WaveGen.sh [-noclean_files]\n\n\
