...
HD_PWD='C:/Xilinx/Projects/WaveGen/WaveGen.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log WaveGen_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source WaveGen_wrapper.tcl -notrace
