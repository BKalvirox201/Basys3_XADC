...
HD_PWD='C:/Xilinx/Projects/WaveGen/WaveGen.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log WaveGen_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source WaveGen_wrapper.tcl
