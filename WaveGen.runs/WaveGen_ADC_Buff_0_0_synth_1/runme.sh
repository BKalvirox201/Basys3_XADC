...
HD_PWD='C:/Xilinx/Projects/WaveGen/WaveGen.runs/WaveGen_ADC_Buff_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log WaveGen_ADC_Buff_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source WaveGen_ADC_Buff_0_0.tcl
