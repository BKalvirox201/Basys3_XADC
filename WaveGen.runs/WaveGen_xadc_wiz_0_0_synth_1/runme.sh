...
HD_PWD='C:/Xilinx/Projects/WaveGen/WaveGen.runs/WaveGen_xadc_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log WaveGen_xadc_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source WaveGen_xadc_wiz_0_0.tcl
